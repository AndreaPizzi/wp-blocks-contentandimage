...
if( function_exists('acf_register_block') ) {
  ...
  $result = acf_register_block(array(
      'name'              => 'nt_contentAndImg_block', // Name of our block
      'title'             => __('NTNext - Content And Image Block'), // Title of our block
      'description'       => __('Block for content and image.'), // Description of our block
